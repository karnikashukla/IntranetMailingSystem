...
<head>
    <title>Intranet Mailing System | Compose mail</title>
    ...
    <div class="main-content">
        <div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
            ...
            <span class="icon-bar"></span>
                        ...
                        <div class="navbar-header">
                            <div class="navbar-header">
                                <h1><a class="navbar-brand" href="Admin_dashboard.html"><span class="glyphicon glyphicon-envelope"></span>  MAIL<span class="dashboard_text"></span></a></h1>
                            </div>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="treeview">
                                        ...
                                        <ul class="treeview-menu">
                                            <li><a href="tables.html"><i class="fa fa-angle-right"></i></a></li>
                                        </ul>
                                    </li>
                                    <li class="treeview">
                                        <a href="#">
                                        ...
                                        <ul class="treeview-menu">
                                            <li><a href="Admin_inbox.html"><i class="fa fa-angle-right"></i> Mail Inbox </a></li>
                                            <li><a href="Admin_compose.html"><i class="fa fa-angle-right"></i> Compose Mail </a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
            ...
            <div id="page-wrapper">
                <div class="main-page compose">
                    <h2 class="title1">Compose Mail</h2>
                    <div class="col-md-4 compose-left">
                        <div class="folder widget-shadow">
                            <ul>
                                <li class="head"><i class="fa fa-folder" aria-hidden="true"></i>Folders</li>
                                <li><a href="inbox.html"><i class="fa fa-inbox"></i>Inbox <span></span></a></li>
